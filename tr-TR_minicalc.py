...
while True:
    ...
    if soru == "q":
        ...
        sayı9=int(input("Karesini bulmak istediğiniz sayıyı girin: "))
        print(sayı9, "sayısının karesi =",sayı9**2)


    elif soru=="6":
        sayı10=int(input("Karekökünü bulmak istediğiniz sayıyı girin: "))
        print(sayı10,"sayısının karekök =",sayı10**0.5)
